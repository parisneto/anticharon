...
- **PE2-002 — Missing/partial pricing no longer becomes a fabricated `$0` endpoint (`src/anticharon/pricing.py`, `tracker.py`, `discovery.py`):**
  ...
  - Status: `Ready for Retest`. Full evidence, root cause, and regression tests in `docs/plans/pricing-engine-v2/RELEASE_VALIDATION.md#PE2-002`. Spec updated: `docs/specs/spec_v1_anticharon.md` §3.1a.
