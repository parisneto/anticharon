...
- [ ] **Resolve Legacy Lint Debt:** Actively tracked and auto-ratcheted dynamically in `docs/standards/lint_baseline_legacy.txt`. (See `docs/standards/linting.md` for policy).
