...
class _Response:
    def __init__(self, status_code=200, payload=None):
        ...
        self._payload = payload or {"tag_name": "v0.5.5", "html_url": "https://example.test/release"}
...
def test_check_updates_reports_is_latest_with_two_second_timeout(monkeypatch):
    ...
    def fake_get(url, headers, timeout):
        ...
        return _Response(payload={"tag_name": "v0.5.5", "html_url": "https://example.test/release"})
